...
const Sidebar = () => {
  ...
  const {getUsers,users,selectedUser,setSelectedUser,unseenMessages,setUnseenMessages} = useContext(ChatContext);
    ...
    const filtersUsers = input ? users.filter((user)=>user.fullName.toLowerCase().includes(input.toLowerCase())) : users // shows the users whose name matches with the name entered in search bar , otherwise show all the users 
